...
#error TX buffer size is not a power of 2
 ...
 /* ATmega with two USART */
 #define ATMEGA_USART1
 #define UART0_RECEIVE_INTERRUPT   USART2_RX_vect
 #define UART1_RECEIVE_INTERRUPT   USART1_RX_vect
 #define UART0_TRANSMIT_INTERRUPT  USART2_UDRE_vect
 #define UART1_TRANSMIT_INTERRUPT  USART1_UDRE_vect
 #define UART0_STATUS      UCSR2A
 #define UART0_CONTROL     UCSR2B
 #define UART0_CONTROLC    UCSR2C  
 #define UART0_DATA        UDR2
 #define UART0_UDRIE       UDRIE2
 #define UART0_UBRRL       UBRR2L
 #define UART0_UBRRH       UBRR2H
 #define UART0_BIT_U2X     U2X2
 #define UART0_BIT_RXCIE   RXCIE2
 #define UART0_BIT_RXEN    RXEN2
 #define UART0_BIT_TXEN    TXEN2
 #define UART0_BIT_UCSZ0   UCSZ20
 #define UART0_BIT_UCSZ1   UCSZ21 
 #define UART1_STATUS      UCSR1A
 #define UART1_CONTROL     UCSR1B
 #define UART1_CONTROLC    UCSR1C  
 #define UART1_DATA        UDR1
